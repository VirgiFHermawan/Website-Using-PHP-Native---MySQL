...
$siswa = query("SELECT * FROM absen ORDER BY kode_karyawan DESC");
?>
...
<div class="container">
    <div class="row my-3">
        <div class="col-md">
            <h3 class="text-uppercase text-center fw-bold">Data Hadir Karyawan</h3>
        </div>
        <hr>
    </div>
    <div class="row">
        <div class="col-md">
            <a href="addDataHadir.php" class = "btn btn-primary"><i class="bi bi-person-plus-fill"></i>&nbsp;Tambah Data</a>
                        ...
                        <?php foreach ($siswa as $row) : ?>
                            <tr>
                                ...
                                <td> 
                                    ...
                                    <a href="ubahHadir.php?kode_karyawan=<?= $row['kode_karyawan']; ?>" class="btn btn-warning btn-sm" style="font-weight: 600;"><i class="bi bi-pencil-square"></i>&nbsp;Ubah</a> |

                                    <a href="hapusHadir.php?kode_karyawan=<?= $row['kode_karyawan']; ?>" class="btn btn-danger btn-sm" style="font-weight: 600;" onclick="return confirm('Apakah anda yakin ingin menghapus data <?= $row['nama_karyawan']; ?> ?');"><i class="bi bi-trash-fill"></i>&nbsp;Hapus</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title fw-bold text-uppercase" id="detail">Detail Data Hadir Karyawan</h5>
