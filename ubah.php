...
$siswa = query("SELECT * FROM karyawan WHERE kode_karyawan = $nis")[0];
            ...
            <div class="col-md">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control w-50" id="umur" value="<?= $siswa['umur']; ?>" name="umur" autocomplete="off" required>
                    </div>
                       <label>Jenis Kelamin</label>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="jekel" id="Laki-laki" value="Perempuan" <?php if ($siswa['jekel']=='Perempuan') { ?> checked='' <?php } ?>>
