...
$siswa = query("SELECT * FROM karyawan ORDER BY kode_karyawan DESC");
?>
...
<div class="container">
    <div class="row my-3">
        <div class="col-md">
            <h3 class="text-uppercase text-center fw-bold">Data Karyawan</h3>
        </div>
        <hr>
    </div>
    <div class="row">
                        ...
                        <?php foreach ($siswa as $row) : ?>
                            <tr>
                                ...
                                <td> 
                                    ...
                                    <a href="ubah.php?kode_karyawan=<?= $row['kode_karyawan']; ?>" class="btn btn-warning btn-sm" style="font-weight: 600;"><i class="bi bi-pencil-square"></i>&nbsp;Ubah</a> |

                                    <a href="hapus.php?kode_karyawan=<?= $row['kode_karyawan']; ?>" class="btn btn-danger btn-sm" style="font-weight: 600;" onclick="return confirm('Apakah anda yakin ingin menghapus data <?= $row['nama_karyawan']; ?> ?');"><i class="bi bi-trash-fill"></i>&nbsp;Hapus</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
