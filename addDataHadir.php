...
if (isset($_POST['simpan'])) {
    if (tambah($_POST) > 0) {
        echo "<script>
                alert('Data hadir karyawan berhasil ditambahkan!');
                document.location.href = 'welcomeHadir.php';
            </script>";
    } else {
        // Jika fungsi tambah dari 0/data tidak tersimpan, maka munculkan alert dibawah
        echo "<script>
                alert('Data hadir karyawan gagal ditambahkan!');
            </script>";
    }
}
...
<div class="container">
    <div class="row my-3">
        <div class="col-md">
            <h2><i class="bi bi-person-plus-fill"></i>&nbsp;Tambah Data Hadir Karyawan </h2> 
        </div>
        <hr>
    </div>
    <div class="row my-2">
            <div class="col-md">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control w-50" id="hadir" placeholder="Masukkan Hadir" name="hadir" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                        <label for="terlambat" class="form-label">Terlambat</label>
                        <input type="number" class="form-control w-50" id="terlambat" placeholder="Masukkan Terlambat" name="terlambat" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                        <label for="cuti" class="form-label">Cuti</label>
                        <input type="number" class="form-control w-50" id="cuti" placeholder="Masukkan Cuti" name="cuti" autocomplete="off" required>
                    </div>
